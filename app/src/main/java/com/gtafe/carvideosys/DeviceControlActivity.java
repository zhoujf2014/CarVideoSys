...
public class DeviceControlActivity extends Activity {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            }else if(BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED.equals(action)) //可以开始干活了
            {
            	...
            	byte[] bytes = intent.getByteArrayExtra(BluetoothLeService.EXTRA_DATA);
            	 String datas = byteToHexString(bytes);
            	if (data != null) {
                	if (mDataField.length() > 500)
                		mDataField.setText("");
                    mDataField.append(datas); 
    ...
    public void onCreate(Bundle savedInstanceState) {                                        //初始化
        ...
        edtSend.setText("A5 A5 49 01 00 00 00 00 00 00 00 00 00 00 00 00 48 5A 5A");
